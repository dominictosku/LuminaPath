...
namespace LuminaPath.Infrastructure.Migrations
{
    ...
    [Migration("20260620192830_QuestSeriesRecurrenceEdits")]
    partial class QuestSeriesRecurrenceEdits
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LuminaPath.Core.Models.Quest", b =>
                {
                    ...
                    b.Property<bool>("OverridesQuestSeries")
                        .HasColumnType("boolean");

                    b.Property<int>("Priority")
                        .HasColumnType("integer");

                    b.Property<bool>("ProjectsQuestSeries")
                        .HasColumnType("boolean");

                    b.Property<int?>("QuestFolderId")
                        .HasColumnType("integer");

                    b.Property<int?>("QuestSeriesId")
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime?>("SeriesOccurrenceDate")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("LuminaUserId", "QuestSeriesId", "SeriesOccurrenceDate");
            ...
            modelBuilder.Entity("LuminaPath.Core.Models.QuestSeries", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("LuminaUserId", "Recurrence");

                    b.HasIndex("LuminaUserId", "ScheduledStartAt");

                    b.ToTable("QuestSeries");
                });
            ...
            modelBuilder.Entity("LuminaPath.Core.Models.Quest", b =>
                {
                    ...
                    b.HasOne("LuminaPath.Core.Models.QuestSeries", "QuestSeries")
                        .WithMany("Quests")
                        .HasForeignKey("QuestSeriesId")
                        .OnDelete(DeleteBehavior.SetNull);
