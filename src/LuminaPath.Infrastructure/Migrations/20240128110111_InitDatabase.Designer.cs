...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240128110111_InitDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Base.Quest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.Gaming.Game", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.Gaming.MyGame", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.Quests.GamesQuest", b =>
                {
                    b.HasBaseType("Domain.Models.Base.Quest");
            ...
            modelBuilder.Entity("Domain.Models.Gaming.Game", b =>
                {
                    b.HasOne("Domain.Models.MediaFile", "Image")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Models.Gaming.MyGame", b =>
                {
                    b.HasOne("Domain.Models.Gaming.Game", "Game")
                        .WithMany("MyGames")
            ...
            modelBuilder.Entity("Domain.Models.Quests.GamesQuest", b =>
                {
                    b.HasOne("Domain.Models.Gaming.Game", "Games")
                        .WithMany()
