...
{
    /// <inheritdoc />
    public partial class BackgroundJobsForBackups : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResultMessage = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BackgroundJobs_JobType_CreatedAt",
                table: "BackgroundJobs",
